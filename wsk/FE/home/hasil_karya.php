  ...
  <section class="section">
    <div class="container">
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="remarks" role="tabpanel" aria-labelledby="attributes-tab"><section class="section">
            ...
            <div class="tab-pane fade" id="attributes" role="tabpanel" aria-labelledby="attributes-tab"><section class="section">
              ...
              <div class="tab-pane fade" id="attachments" role="tabpanel" aria-labelledby="attachments-tab"><section class="section"></section>
                <div class="row itembox">
            ...
            <div class="tab-pane fade" id="edit" role="tabpanel" aria-labelledby="attachments-tab"><section class="section"></section>
              <div class="container">
                <div class="col-sm-12 col-md-6">
                  <div class="col-12 col-md-8 col-lg-8 "><h2>Edit</h2></div>
